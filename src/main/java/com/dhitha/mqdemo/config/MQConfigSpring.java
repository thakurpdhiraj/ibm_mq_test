...
public class MQConfigSpring {
  ...
  // docker run --env LICENSE=accept --env MQ_APP_PASSWORD=passw0rd --env MQ_Q
  // --publish 1414:1414 --publish 9443:9443 --detach
  // --name QM1 MGR_NAME=QM1 -- icr.io/ibm-messaging/mq:9.2.0.0-r1
  ...
  @Bean("mqQueueConnectionFactory1")
  public MQQueueConnectionFactory mqQueueConnectionFactory1() throws JMSException {
  ...
  @Bean(name = "defaultJmsListenerContainerFactory1")
  public DefaultJmsListenerContainerFactory defaultJmsListenerContainerFactory1(
     @Qualifier("mqQueueConnectionFactory1") MQQueueConnectionFactory mqQueueConnectionFactory1) {
    DefaultJmsListenerContainerFactory factory = new DefaultJmsListenerContainerFactory();
    factory.setConnectionFactory(mqQueueConnectionFactory1);
